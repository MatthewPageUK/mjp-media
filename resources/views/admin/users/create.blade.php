<div class="py-8 px-4 mx-auto max-w-4xl lg:py-16">
    ...
    <div class="mb-8 justify-end flex gap-2">
        <h1 class="flex-1 text-4xl font-semibold text-gray-900 dark:text-white">Create User</h1>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <form action="#">
            ...
            <div class="mt-16 text-right">
                <x-primary-button wire:click.prevent="save">Create new user</x-primary-button>
            </div>
        </form>
        </div>
      </section>
