<section>
    ...
    <div class="relative overflow-x-auto sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-100">
            <thead class="text-xs XXtext-gray-100 uppercase bg-primary-600">
                <tr>
            ...
            <tbody>
                ...
                @foreach ($this->users as $user)
                    <tr class="border-b text-gray-100 hover:text-gray-900 hover:bg-secondary-300">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-2 flex items-center justify-end">
                                <x-action-button href="{{ route('user.read', $user) }}">
                                ...
                                <x-action-button href="{{ route('user.update', $user) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
