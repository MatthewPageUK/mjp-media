            ...
            <div class="col-span-2">
                ...
                <div class="max-h-[500px] overflow-y-auto">
                    @foreach (Storage::allFiles($this->user->storagePath) as $file)
                        <div class="rounded-lg b-1 p-2 bg-blue-50 hover:bg-blue-200 text-xs flex items-center gap-2">
                            ...
                            <span class="py-1 px-2 rounded-lg text-xs font-bold bg-blue-300">{{ Storage::size($file) }}b</span>
                        </div>
                    @endforeach
                </div>
            </div>
