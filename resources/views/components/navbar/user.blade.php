...
>
    <div class="overflow-y-auto py-5 px-3 h-full bg-blue-900 dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('dashboard') }}" class="flex items-center p-2 text-base font-medium text-gray-200 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('ui.explorer') }}" class="flex items-center p-2 text-base font-medium text-gray-200 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group">
