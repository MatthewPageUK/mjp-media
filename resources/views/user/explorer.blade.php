...
<div class="mt-12 lg:mt-0">
    ...
    <div class="md:flex items-center gap-2 mb-2 space-y-4">

        {{-- Title --}}
        <h1 class="flex-1 text-4xl md:text-6xl font-black tracking-tight text-gray-100">File Explorer</h1>

        {{-- Create directory --}}
        <x-primary-button wire:click.prevent="showCreateDirectory">
        ...
        {{-- Upload file --}}
        <x-primary-button wire:click.prevent="showFileUpload()">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        @switch ($this->mode)
            @case ('preview')
                {{-- View list --}}
                <x-primary-button wire:click.prevent="setListMode" title="View files in a list">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            @default
                ...
                <x-primary-button wire:click.prevent="setPreviewMode" title="View files in a grid with image preview">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div class="mb-8 text-gray-300 text-xs w-1/4">
        <span class="pl-1">{{ Str::humanFileSize(Auth::user()->capacityUsed) }} in {{ Auth::user()->totalFiles }} files</span>
